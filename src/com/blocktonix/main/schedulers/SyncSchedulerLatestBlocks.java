 ...
 * subsequent blocks starting from the latest block number. Scan for 10 descending blocks from
 * latest blocknumber
 * 
 * @author sv
 */
...
public class SyncSchedulerLatestBlocks implements Job
{

  public static final Logger logger = LoggerFactory.getLogger(SyncSchedulerLatestBlocks.class);
